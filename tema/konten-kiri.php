<div class="logo-kiri"></div>
<div class="box-user">
    <?php include 'user-data.php';?>
</div>
<div id='cssmenu'>
 <ul>
     <li><a href='#' class="aktif"><i class="fa fa-home"></i> <label>Beranda</label> </a></li>
                <li><a href='karyawan'><i class="fa fa-users"></i> <label>Karyawan</label> </a></li>
