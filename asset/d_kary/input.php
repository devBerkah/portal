...
<html>
	...
	<form action='save_kary.php' method='post'>
		<div>
			<label><b>Input Data Karyawan</b><label>
		</div>
		...
		<div>
			<label>Agama</label>
			<select name="agama"><option>--Pilih Agama--</option>
		...
		<div>
			<label>Unit</label>
			<select name="id_unit"><option value=''>--Pilih Unit--</option>
				<?php
		...
		<div>
			<label>Jabatan</label>
			<select name="id_jabatan"><option value=''>--Pilih Jabatan--</option>
				<?php
		...
		<div>
			<label>Bank</label>
			<select name="kd_bank"><option value=''>--Pilih Bank--</option>
				<?php
		...
		<div>
			...
			<select name="pend_akhir"><option value=''>-Pilih Pendidikan Terakhir--</option>
		...
		<div>
			...
			<select name="gol_darah"><option value=''>--Pilih Golongan Darah--</option>
